// <copyright file="ManagementApiApplicationRegistrationManagerShould.cs" company="Okta, Inc">
...
{
    [TestClass]
    public class ManagementApiApplicationRegistrationManagerShould
    {
        [TestMethod]
        public void ListApplications()
        {
            ApplicationRegistrationManager registration = new ManagementApiApplicationRegistrationManager();
        ...
        public void RegisterClientApplication()
        {
            ...
            ApplicationRegistrationManager registrationManager = new ManagementApiApplicationRegistrationManager();
